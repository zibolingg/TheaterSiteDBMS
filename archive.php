...
<html lang="en-US" dir="ltr">
  <head>
    ...
    =============================================
    -->
    <title>Archive | Local Movie Theater</title>
    <!--  
    Favicons
    =============================================
    -->
    ...
    <main>
      ...
      <div class="main">
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <div class="module-subtitle font-serif">Search Our Previous Releases</div>
              </div>
            </div>
          </div>
        </section>
        <section class="module">
          <div class="container">
			  <form id="form" method="post" action="searchresults.php" style="justify-content: center;">
            ...
            <div class="row multi-columns-row post-columns">
				...
				while($master_count < $GLOBALS['trailer_count']){
					...
					echo '<button class="btn btn-sm btn-block btn-round btn-d" type="submit" ';
					if(!isset($add_movie)){echo 'style="display:none;"';}
					echo 'name="delete" value="';
					echo htmlspecialchars(${'id'.$master_count});
					echo '">Delete Movie</button>
					  </form></div>';
	  		 ...
	  		 ?>
				<button <?php if(!isset($add_movie)){echo 'style="display:none;"';} ?> class="btn btn-lg btn-block btn-round btn-d" type = "button" onclick="window.location.href = 'addmovie.php';">Add Movie
					   </button>
