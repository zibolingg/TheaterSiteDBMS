<?php 
	...
	if (isset($_SESSION['error'])){
		...
		if($_SESSION['error'] == 2){
			$email = "You have entered an invalid subject.";
		}
		if($_SESSION['error'] == 3){
			$email = "You have entered an invalid message.";
		}
...
<html lang="en-US" dir="ltr">
  <head>
    ...
    =============================================
    -->
    <title>Contact Us | Local Movie Theater</title>
    <!--  
    Favicons
    =============================================
    -->
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form class="form" name="form" role="form" method="post" action="contactThankYou_nonuser.php">
                  <div class="form-group">
					<p style="color:red;"><?php echo $email; ?></p>
                    <input class="form-control" type="email" name="email" style="text-transform: none;" placeholder="Enter Email (ex. email@site.net)" required/>
                  </div>
				  <div class="form-group">
					<p style="color:red;"><?php echo $subject; ?></p>
                    <input class="form-control" type="text" name="subject" style="text-transform: none;" placeholder="Enter Subject" required/>
                  </div>
				  <p style="color:red;"><?php echo $message; ?></p>
                  <textarea class="form-control" rows="7" name="message" style="text-transform: none;" placeholder="Message" required></textarea><br>
					<button class="btn btn-lg btn-block btn-round btn-d" type="submit">Send Message</button>
                </form>
              </div>
            </div>
          </div>
