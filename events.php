...
<html lang="en-US" dir="ltr">
  <head>
    ...
    =============================================
    -->
    <title>Events | Local Movie Theater</title>
    <!--  
    Favicons
    =============================================
    -->
                ...
                <div class="row multi-columns-row mb-70">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="content-box">
                      ...
                      <h3 class="content-box-title font-serif">Private gaming Party</h3>Host a private big-screen video game party! <a href="contact.php"><b>Contact Us</b></a>
                    </div>
					</div>
				  </div>
				  </div>
