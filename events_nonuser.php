...
<html lang="en-US" dir="ltr">
  <head>
    ...
    =============================================
    -->
    <title>Event | Local Movie Theater</title>
    <!--  
    Favicons
    =============================================
    -->
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
               <h2 class="module-title font-alt">Events</h2>
                <div class="module-subtitle font-serif">Book Your Next Meeting or Special Event on the Big Screen</div>
              </div>
            </div>
          </div>
        </section>
                ...
                <div class="row multi-columns-row mb-70">
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="content-box">
                      <div class="content-box-image"><img src="assets/images/PremiumPrivateScreenings.png" /></div>
                      <h3 class="content-box-title font-serif">Premium Private Screenings</h3>Hold a private screening of the latest blockbuster or a favorite classic film.
					  <a href="contact_nonuser.php"><b>Contact Us</b></a>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="content-box">
                      <div class="content-box-image"><img src="assets/images/MeetingsSpecialEvents.png" /></div>
                      <h3 class="content-box-title font-serif">Meetings & Special Events</h3>Make your next meeting or special event more exciting in one of our auditorium.
					  <a href="contact_nonuser.php"><b>Contact Us</b></a>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="content-box">
                      <div class="content-box-image"><img src="assets/images/birthday.png" /></div>
                      <h3 class="content-box-title font-serif">Birthday parties</h3>Host your child's birthday party at Cinema today! Each kid will receive 10 free arcade tokens.
					  <a href="contact_nonuser.php"><b>Contact Us</b></a>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="content-box">
                      <div class="content-box-image"><img src="assets/images/privategaming.png" /></div>
                      <h3 class="content-box-title font-serif">Private gaming Party</h3>Host a private big-screen video game party! <a href="contact_nonuser.php"><b>Contact Us</b></a>
                    </div>
					</div>
				  </div>
				 </div>
