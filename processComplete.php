<?php 
	...
	if(isset($reservation_id)){
		$query = "update reservation set active = FALSE where reservation_id = $reservation_id;";
		$db_conn->query($query);
		$message = "All set! Enjoy the movie.";
	} else {
		$message = "Whoops! You're on the wrong page.";
	}
...
<html lang="en-US" dir="ltr">
  <head>
    ...
    =============================================
    -->
    <title>Tickets Redeemed | Local Movie Theater</title>
    <!--  
    Favicons
    =============================================
    -->
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">Redemption Complete</h1>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
				<div class="module-subtitle font-serif"><?php echo htmlspecialchars($message);?></div>
				<br><br>
				<button class="btn btn-sm btn-block btn-round btn-d" type = "button" onclick="window.location.href = 'viewprofile.php';">Back to Profile
				</button>
              </div>
            </div>
          </div>
