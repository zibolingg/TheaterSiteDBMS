...
<html lang="en-US" dir="ltr">
  <head>
    ...
    =============================================
    -->
    <title>Message Submitted | Local Movie Theater</title>
    <!--  
    Favicons
    =============================================
    -->
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
				...
				<button class="btn btn-sm btn-block btn-round btn-d" type = "button" onclick="window.location.href = 'contact.php';">Back
					   </button>
              </div>
            </div>
          </div>
